...
exports.updateConnectConfig = (baseUrl) => {
  ...
  if (!fs.existsSync(configPath)) {
    throw new Error('could not find atlassian-connect.json file. The file should be placed in \'public\' directory');
  }
...
exports.setHostVariable = (env) => {
  ...
  fs.readFile(filePath, 'utf-8', (err, data) => {
    const updatedScript = getUpdatedScript(env, data);
...
function getFilePath(env) {
  ...
  return path.join(__dirname, `../node_modules/react-scripts-ts/scripts/${fileName}.js`);
}
